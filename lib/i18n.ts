export type Locale = "en" | "ar" | "hi" | "ur" | "tl";
...
const baseTranslations: Record<"en" | "ar", Record<string, string>> = {
  ...
  ar: {
    // Header
    "header.tagline": "\u0628\u064f\u0646\u064a \u0628\u0648\u0627\u0633\u0637\u0629 \u0623\u062e\u0635\u0627\u0626\u064a \u0645\u0648\u0627\u0631\u062f \u0628\u0634\u0631\u064a\u0629",
    ...
    "hero.trust2": "\u0628\u062f\u0648\u0646 \u0628\u0637\u0627\u0642\u0629 \u0627\u0626\u062a\u0645\u0627\u0646",
    "hero.trust3": "\u0645\u0639\u062a\u0645\u062f \u0645\u0646 \u0623\u062e\u0635\u0627\u0626\u064a \u0645\u0648\u0627\u0631\u062f \u0628\u0634\u0631\u064a\u0629",
    ...
    "score.roastDesc":
      "\u0627\u062d\u0635\u0644 \u0639\u0644\u0649 \u0645\u0644\u0627\u062d\u0638\u0627\u062a \u0635\u0631\u064a\u062d\u0629 \u0645\u0646 \u0623\u062e\u0635\u0627\u0626\u064a \u0645\u0648\u0627\u0631\u062f \u0628\u0634\u0631\u064a\u0629 \u0639\u0644\u0649 \u0633\u064a\u0631\u062a\u0643 \u0627\u0644\u0630\u0627\u062a\u064a\u0629",
    ...
    // HR Tips
    "tip.label": "\u0646\u0635\u064a\u062d\u0629 \u0623\u062e\u0635\u0627\u0626\u064a \u0627\u0644\u0645\u0648\u0627\u0631\u062f \u0627\u0644\u0628\u0634\u0631\u064a\u0629",
    "tip.email":
...
const languageOverrides: Record<Exclude<Locale, "en" | "ar">, Record<string, string>> = {
  hi: {
    "header.tagline": "HR करियर विशेषज्ञ द्वारा निर्मित",
    ...
    "hero.trust2": "क्रेडिट कार्ड नहीं",
    "hero.templatesTitle": "9 पेशेवर CV टेम्पलेट",
    "step.template": "टेम्पलेट",
    "step.personal": "व्यक्तिगत जानकारी",
    "step.summary": "पेशेवर सारांश",
    "step.experience": "अनुभव",
    "step.education": "शिक्षा",
    "step.skills": "कौशल",
    "step.extras": "अतिरिक्त जानकारी",
    "step.score": "CV स्कोर",
    "nav.back": "पीछे",
    "nav.next": "अगला",
  ...
  ur: {
    "header.tagline": "HR کیریئر ماہر کی تیار کردہ",
    ...
    "hero.trust2": "کریڈٹ کارڈ نہیں",
    "hero.templatesTitle": "9 پیشہ ور سی وی ٹیمپلیٹس",
    "step.template": "ٹیمپلیٹ",
    "step.personal": "ذاتی معلومات",
    "step.summary": "پیشہ ور خلاصہ",
    "step.experience": "تجربہ",
    "step.education": "تعلیم",
    "step.skills": "مہارتیں",
    "step.extras": "اضافی معلومات",
    "step.score": "سی وی اسکور",
    "nav.back": "واپس",
    "nav.next": "اگلا",
  ...
  tl: {
    "header.tagline": "Ginawa ng isang HR Career Specialist",
    "header.cvBuilder": "CV Builder",
    ...
    "hero.trust2": "Walang credit card",
    "hero.templatesTitle": "9 propesyonal na CV template",
    "step.template": "Template",
    "step.personal": "Personal na detalye",
    "step.summary": "Propesyonal na buod",
    "step.experience": "Karanasan",
    "step.education": "Edukasyon",
    "step.skills": "Mga kasanayan",
    "step.extras": "Iba pang detalye",
    "step.score": "Iskor ng CV",
    "nav.back": "Bumalik",
    "nav.next": "Susunod",
...
export const translations: Record<Locale, Record<string, string>> = {
  ...
  hi: { ...baseTranslations.en, ...languageOverrides.hi },
  ur: { ...baseTranslations.en, ...languageOverrides.ur },
  tl: { ...baseTranslations.en, ...languageOverrides.tl },
};
